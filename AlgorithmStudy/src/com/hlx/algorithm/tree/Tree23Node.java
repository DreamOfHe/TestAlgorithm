...
public class Tree23Node {
	...
	private Tree23Node childArray[] = new Tree23Node[ORDER];
	private DataItem itemArray[] = new DataItem[ORDER-1];
	
	// connect child to this node
	public void connectChild(int childNum, Tree23Node child){
	...
	public Tree23Node disconnectChild(int childNum){
		Tree23Node tempNode = childArray[childNum];
		childArray[childNum] = null;
		return tempNode;
	}
	
	public Tree23Node getChild(int childNum){
		return childArray[childNum];
	}
	
	public Tree23Node getParent(){
		return parent;
	}
	...
	public void displayNode(){                          // format "/24/56/"
